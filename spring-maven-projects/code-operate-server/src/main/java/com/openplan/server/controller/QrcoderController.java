...
public class QrcoderController {
    ...
    public String actionIndexPage(HttpServletRequest request) {
        LOG.debug("actionIndex");
        return "operate/qrcoder/index";
    }
    
    @RequestMapping("/create.html")
    public String actionCreatePage(HttpServletRequest request) {
        LOG.debug("actionIndex");
        ...
        return "operate/qrcoder/create";
    }
    
    @RequestMapping("/update.html")
    public String actionUpdatePage(HttpServletRequest request) {
        LOG.debug("actionIndex");
        
        return "operate/qrcoder/update";
    }
    
    @RequestMapping("/detail.html")
    public String actionDetailPage(HttpServletRequest request) {
        LOG.debug("actionIndex");

        
        return "operate/qrcode/detail";
    }
