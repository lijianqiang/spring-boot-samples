...
var URLs = {
		...
		query: "/api/placers",
		remove: "/api/placers/",
		viewPage: "/placer/detail.html?id=",
		updatePage: "/placer/update.html?id=",
		qrcoderPage: "/placer/qrcoder.html?id=",
}
...
var placerListTable = new Vue({
		...
		methods: {
			...
			viewItem: function(id) {
				...
				window.location.href = URLs.viewPage + id;
			},
			updateItem: function(id) {
				console.log("updateItem:" + id);
				window.location.href = URLs.updatePage + id;
			},
			qrcoderSetting: function(id) {
				console.log("qrcoderSetting:" + id);
				window.location.href = URLs.qrcoderPage + id;
			},
		}
});
...
var pagination = new Vue({
	...
	methods: {
		...
		previous: function() {
			...
			placerQueryFrom.page = placerQueryFrom.page - 1;
			placerListTable.getPlacers();
		},
		next: function() {
