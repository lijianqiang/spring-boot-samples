package com.openplan.server.mybatis.datasource;
...
@Configuration
@MapperScan(basePackages = "com.openplan.server.mybatis.mapper", sqlSessionTemplateRef = "masterSqlSessionTemplate")
