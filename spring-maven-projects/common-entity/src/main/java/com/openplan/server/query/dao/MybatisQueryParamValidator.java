package com.openplan.server.query.dao;
...
public class MybatisQueryParamValidator {
     ...
     * @return
     */
    public static Map<String, Object> prepareForList(Map<String, Object> params) {
        if (params == null) {
