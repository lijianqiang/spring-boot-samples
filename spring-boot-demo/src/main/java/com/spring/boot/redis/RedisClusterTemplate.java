...
public class RedisClusterTemplate {
    private static final Logger LOG = LoggerFactory.getLogger(RedisClusterTemplate.class);
    ...
    public void setWithExpireTime(String prefix, String key, String value) {
        ...
        LOG.debug("RedisUtil:setWithExpireTime cache key={},value={},expireTime={}", prefix + KEY_SPLIT + key, value, EXPIRE_SECONDS);
    }
